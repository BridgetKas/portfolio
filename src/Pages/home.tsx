...
function HomePage() {
  return (
    <div className='flex flex-col items-center mt-[20px] gap-[20px] w-[90%] mx-auto sm:flex-row sm:mt-[40px] sm:justify-between'>
      <div className='w-full sm:w-[40%] bg-red-500 p-3'>
        <p className='text-[40px] font-bold text-center mb-5'>Hi I'm <span className='text-yellow font-bold'>Bridget.</span> </p>
