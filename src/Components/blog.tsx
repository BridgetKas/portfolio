...
export default function MediaCard(props:propsType) {
  ...
  return (
    <div className=' mb-[10px] flex flex-col items-center gap-2 p-2 w-[90%] h-[440px] mx-auto mt-4 shadow-2xl sm:flex-row sm:h-[320px] md:h-[280px] lg:h-[220px] lg:w-[88%] hover:scale-105 transform  transition-all duration-500 ease-in-out dark:bg-darkFootNav'>
